...
class CitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ($data as $item) {
            $province = Province::where('name', $item['province'])->first();
    ...
    // Seed regions for 'تهران' city from regions.json

    $regionsPath = database_path('seeders/regions.json');
    if (file_exists($regionsPath)) {
        $regionsJson = file_get_contents($regionsPath);
        ...
        if ($tehranCity) {
            foreach ($regionsData as $region) {
                \App\Models\Region::firstOrCreate([
                    ...
                    'province_id' => $tehranCity->province_id,
                ]);
            }
        }
    }
